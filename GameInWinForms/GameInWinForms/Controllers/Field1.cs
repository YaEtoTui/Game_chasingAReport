...
namespace GameInWinForms.Controllers
{
    public static class Field1
    {
        ...
        public static int CountList1;//количество листов в 1 поле

        public static Label Text1 = new Label();

        public static int OpenPoints1;

        /// <summary>
        /// инициализируем текст листов
        /// </summary>
        /// <param name="current"></param>
        public static void InitializeTextList1(Form current)
        {
            Text1.Location = new Point(156, 370);
            Text1.ForeColor = Color.Black;
            Text1.Font = new Font(Text1.Font.FontFamily, 24, Text1.Font.Style);
            Text1.Size = new Size(50, 35);
            Text1.BackColor = Color.White;
            Text1.Text = $"{CountList1}";
            current.Controls.Add(Text1);
        }

        /// <summary>
        /// иинициализирует кнопки 1 поля
        /// </summary>
        /// <param name="CellSize">размер кнопки</param>
        /// <param name="current">форма</param>
        public static void InitializeButtons1(int CellSize, Form current)
        {
        ...
        /// <summary>
        /// инициализирует основные компоненты 1 поля
        /// </summary>
        /// <param name="current">форма</param>
        public static void Initialize1(Form current)
        {
            OpenPoints1 = 0;
            CountList1 = 0;
            form = current;
        ...
        /// <summary>
        /// инициализируем основу поля 1
        /// </summary>
        /// <param name="current">форма</param>
        public static void InitializeMap1()
        {
            for (var i = 0; i < MapControllers.MapSize; i++)
            {
                for (var j = 0; j < MapControllers.MapSize; j++)
        ...
        /// <summary>
        /// здесь проставляем листочки для первого поля
        /// </summary>
        public static void SeedMap()
        {
            ...
            for (var i = 0; i < number; i++)
            {
                ...
                while (Map1[positionI, positionJ] == -1 || (Math.Abs(positionI - FirstCor1.Y) <= 1 && Math.Abs(positionJ - FirstCor1.X) <= 1) || Field2.Map1[positionI, positionJ] == -1)
                {
        ...
        private static void OnLeftButtonPressed(Button pressedButton)
        {
            ...
            if (Map1[buttonI, buttonJ] == -1)
            {
                ...
                Field2.ShowAllLists(buttonI, buttonJ);
